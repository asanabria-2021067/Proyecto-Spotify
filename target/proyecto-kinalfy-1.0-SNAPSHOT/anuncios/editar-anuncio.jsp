                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-4 mb-4">
                                        <a class="btn btn-secondary" href="${pageContext.request.contextPath}/ServletAnuncios?accion=listar">
                        ...
                        <form method="POST" action="${pageContext.request.contextPath}/ServletAnuncios"  class="was-validated">
                            ...
                            <div class="modal-body ">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="id" name="id" value="${anuncio.id}" readOnly="true">
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-6 text-center">
                                        <a class="btn btn-danger"href="${pageContext.request.contextPath}/ServletAnuncios?accion=eliminar&id=${anuncio.id}"> 
                                            <i class="fa-solid fa-trash"></i> Eliminar Anuncios
                                        </a>
                                    </div>
